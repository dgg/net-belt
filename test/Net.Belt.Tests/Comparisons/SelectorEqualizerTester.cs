...
public class SelectorEqualizerTester
{
	...
	public void Explore()
		...
		{
			IEqualityComparer<string> subject = new SelectorEqualizer<string, string>(_ => null!);
		...
		{
			EqualitySpy spyForX = new EqualitySpy(), spyForY = new();
		...
		{
			EqualitySubject x1 = new ("x", 1, 1m), x2 = new ("x", 1, 2m);
