...
public class ComparisonComparerTester
{
	[Test, Category("Exploratory")]
		public void Explore()
		{
			...
			var subject = new ComparisonComparer<ComparisonSubject>(compare2);
		...
		private static readonly ComparisonSubject _a = new("A", 4, 7.60m);
		...
		public void CanBeChained()
		{
			...
			Assert.That(list, Doez.RepresentAs("B, A, C"));
		}
