...
public class StringExtensionsTester
{
    ...
    [TestCase("lazy lazy fox jumped", "l", "azy lazy fox jumped",
        Description = "contained char --> right from first index")]
    [TestCase("lazy lazy fox jumped", "f", "ox jumped", Description = "only contained char --> right from index")]
    [TestCase("lazy lazy fox jumped", "azy", " lazy fox jumped",
        Description = "contained string --> right from first index + len")]
    ...
    [TestCase("lazy lazy fox jumped", "f", "ox jumped", Description = "only contained char --> right from index")]
    [TestCase("lazy lazy fox jumped", "azy", " fox jumped",
        Description = "contained string --> right from last index + len")]
    [TestCase("lazy lazy fox jumped", "d", "", Description = "end char --> empty")]
    [TestCase("lazy lazy fox jumped", "ed", "", Description = "end substring --> empty")]
    [TestCase("lazy lazy fox jumped", "c", null, Description = "not found --> empty substring")]
    [TestCase("lazy lazy fox jumped", "lozy", null, Description = "not found --> empty substring")]
    ...
    [TestCase("lazy lazy fox jumped", "ed", "lazy lazy fox jump",
        Description = "last substring --> remove last substring")]
    ...
    [TestCase("lazy lazy fox jumped", "d", "lazy lazy fox jumpe", Description = "last char --> remove last")]
    [TestCase("lazy lazy fox jumped", "ed", "lazy lazy fox jump",
        Description = "last substring --> remove lsat substring")]
    [TestCase("lazy lazy fox jumped", "c", null, Description = "not found --> empty substring")]
    [TestCase("lazy lazy fox jumped", "lozy", null, Description = "not found string --> empty substring")]
    [TestCase("DOMAIN\\username", "\\", "DOMAIN")]
    ...
    [Test]
    public void AppendIfNotThere_Comparison_UsedWhenSearching()
    {
        string input = "abc";

        Assert.That(input.IfNotThere.Append("C", StringComparison.InvariantCultureIgnoreCase),
            Is.EqualTo(input));
    }
    ...
    [Test]
    public void PrependIfNotThere_Comparison_UsedWhenSearching()
    {
        string input = "abc";

        Assert.That(input.IfNotThere.Prepend("A", StringComparison.InvariantCultureIgnoreCase), 
            Is.EqualTo(input));
    }
